<template>
    <div>
        <div class="line-header">
            <span style="margin-right:25px">搜索用户数</span>
            <svg t="1651976868538" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="1912" width="16" height="16">
                <path
                    d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64z m0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372z"
                    p-id="1913"></path>
                <path d="M512 336m-48 0a48 48 0 1 0 96 0 48 48 0 1 0-96 0Z" p-id="1914"></path>
                <path d="M536 448h-48c-4.4 0-8 3.6-8 8v272c0 4.4 3.6 8 8 8h48c4.4 0 8-3.6 8-8V456c0-4.4-3.6-8-8-8z"
                    p-id="1915"></path>
            </svg>
        </div>
        <div>
            <h4 style="display:inline-block;margin-right:20px">{{ title }}</h4>
            <span>{{ number }}
                <svg t="1651977647638" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="1982" width="16" height="16">
                    <path
                    ...
                    <path
                        ...
                        fill="#1afa29" p-id="1986"></path>
                    <path d="M384.1536 444.142933h1.5872l-20.48 409.6h268.2368l-20.48-409.6" fill="#1afa29" p-id="1987">
                    </path>
                    <path
                    ...
                    <path
                        ...
                        fill="#1afa29" p-id="1992"></path>
                </svg>
                <svg t="1651850035089" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="2857" width="16" height="16">
                    <path
                        d="M252.484267 566.749867h11.776v16.6912h-11.776zM815.684267 566.8352h10.461866v16.9984h-10.461866z"
                        fill="#996E28" p-id="2858"></path>
                    <path
                    ...
                    <path
                        ...
                        fill="#E8D4AB" p-id="2861"></path>
                    <path d="M654.523733 591.854933h-1.5872l20.48-409.6H405.1968l20.48 409.6" fill="#AF3131"
                        p-id="2862"></path>
                    <path d="M654.523733 593.5616h-1.5872l20.48-409.6H405.1968l20.48 409.6" fill="#D5382E" p-id="2863">
                    </path>
                    <path
    ...
    mounted() {
        ...
        myCharts.setOption({
            ...
            series: [{
                type: 'line',
                symbol: 'none',//去掉拐点
                smooth: true,//true为平滑，false为z直线
                data: [22, 45, 18, 12, 55, 4, 58, 33],
                itemStyle: {
                    //折线颜色
                    color: 'skyblue'
                },
