    ...
    <div>
        <el-row :gutter="10">
            <el-col :span="6" :offset="0">
                <el-card>
                    <detail-index title="总销售额" content="￥126560" footer="日销售额￥12423">
                        <template slot="charts">
                            <span>同周比 </span>
                            <span>56.3%</span>
                            <i><svg t="1651977647638" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            ...
                            <span>同日比</span>
                            <span>19.16%</span>
                            <i><svg t="1651850035089" class="icon" viewBox="0 0 1024 1024" version="1.1"
            ...
            <el-col :span="6" :offset="0">
                <el-card>
                    <detail-index title="访问量" content="￥126560" footer="日销访问量12423">
                        <template slot="charts">
            ...
            <el-col :span="6" :offset="0">
                <el-card>
                    <detail-index title="支付笔数" content="￥126560" footer="转换率60%">
                        <template slot="charts">
                            <barCharts></barCharts>
                        </template>
                    </detail-index>
            ...
            <el-col :span="6" :offset="0">
                <el-card>
                    <detail-index title="运营活动效果" content="73%" footer="日销售额￥12423">
                        <template slot="charts">
